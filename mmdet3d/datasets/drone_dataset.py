...
class DroneDataset(Custom3DDataset):
    r"""Drone Dataset.

    This class is based on the KITTI dataset comprising of point cloud and annotations.
    Args:
    ...
    def get_ann_info(self, index):
        ...
        Returns:
            dict: annotation information consists of the following keys:
                ...
                - gt_bboxes (np.ndarray): 2D ground truth bboxes. --> removed
