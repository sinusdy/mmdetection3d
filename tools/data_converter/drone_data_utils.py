...
def get_label_path(idx,
                   ...
                   info_type='label_2',
                   use_prefix_id=False):
    return get_drone_info_path(idx, prefix, info_type, '.txt', training,
...
def get_velodyne_path(idx,
                      ...
                      exist_check=True,
                      use_prefix_id=False):
    return get_drone_info_path(idx, prefix, 'velodyne', '.bin', training,
                               relative_path, exist_check, use_prefix_id)
...
def get_drone_info(path,
    ...
    """
    Drone annotation format version 2:
    {
        point_cloud: {
            num_features: 4
            velodyne_path: ...
